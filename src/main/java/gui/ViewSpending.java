...
public class ViewSpending extends javax.swing.JFrame {
    ...
    private void displayCategory(){
        try{ 
        ResultSet rs=db.dbConnect.st.executeQuery("select * from spendingdb.category_info");   
        while(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(dd1, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(totalAmount2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs=db.dbConnect.st.executeQuery("select * from spendingdb.spending where sdate>='"+dt1+"' and sdate<='"+dt2+"' order by sdate asc");
        int total=0;
        while(rs.next()){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            ResultSet rs=db.dbConnect.st.executeQuery("select * from spendingdb.spending where sdate>='"+dt1+"' and sdate<='"+dt2+"' and category='"+c+"' order by sdate asc");
            int total=0;
            while(rs.next()){
                int t=rs.getInt("amount");
                total+=t;
